...
async def output_info(message):
    await message.answer('Производится расчет калорий для оптимального похудения или сохранения нормального веса\n'
...
async def set_age(message):
    ...
    await message.answer('Выберете пол', reply_markup = kb1)
